...
public class MenuPresidente {
	...
	public void menuPresidente(Presidente presidente) throws ExcecaoTransferencias, IOException {

		Scanner sc = new Scanner(System.in);

		int option = 0;
		Extrato e = new Extrato();
		Conta conta = Conta.listaConta.get(presidente.getCpf());
		...
		while (option != 11) {
			...
			case 10:
				System.out.println("O capital total do banco é de: " + Conta.calcCapital());
