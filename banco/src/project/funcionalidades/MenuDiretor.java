...
public class MenuDiretor {
	...
	public static void menuDiretor(Diretor diretor,Scanner sc,Map<String,Pessoa> listaPessoa,Map<String, Conta> listaConta,ArrayList<Saque> saques,ArrayList<Deposito> depositos,ArrayList<Transferencia> transferencias) throws ExcecaoTransferencias, IOException {


		int option = 0;
		Extrato e = new Extrato();
		Conta conta = listaConta.get(diretor.getCpf());
